                            ...
                            {[
                                {
                                    ...
                                    description:
                                        "Optimiza la organización de tus mesas y clientes.",
                                    icon: "fas fa-calendar-check",
                                },
                                {
                                    title: "Control de Inventario",
                                    description:
                                        "Mantén un registro preciso de tus suministros.",
                                    icon: "fas fa-boxes",
                                },
                                {
                                    title: "Análisis de Datos",
                                    description:
                                        "Toma decisiones informadas con estadísticas detalladas.",
                                    icon: "fas fa-chart-line",
                                },
                            ].map((feature, index) => (
                                <div
                                    key={index}
                                    className="bg-white p-6 rounded-lg shadow-lg overflow-hidden relative group">
                                    <div className="transition-all duration-300 ease-in-out transform group-hover:-translate-y-full">
                                        <i
                                            className={`${feature.icon} text-4xl text-indigo-600 mb-4`}></i>
                                    ...
                                    <div className="absolute inset-0 bg-indigo-600 text-white p-6 transition-all duration-300 ease-in-out transform translate-y-full group-hover:translate-y-0 flex items-center justify-center text-center">
                                        <p className="text-lg">
                                            Descubre cómo esta funcionalidad
                                            puede revolucionar tu negocio
                                        </p>
                                    </div>
                                </div>
                            ))}
                            ...
                            {[
                                {
                                    ...
                                    icon: FaMobileAlt,
                                    description:
                                        "Accede a tu restaurante desde cualquier lugar con nuestra app móvil.",
                                },
                                {
                                    name: "Tablet",
                                    icon: FaTabletAlt,
                                    description:
                                        "Perfecta para tomar pedidos en mesa o gestionar el inventario.",
                                },
                                {
                                    name: "Escritorio",
                                    icon: FaDesktop,
                                    description:
                                        "Gestiona tu negocio con todas las funcionalidades en tu ordenador.",
                                },
                            ].map((device, index) => (
